<?php include 'header.php'?>
    ...
    <div class="container mt-5">
        ...
        <p class="text_justify pt-3">At Bhagirath Technologies Private Limited, we pride ourselves on being your
        ...
        <div class="container">
            <h3 class="set-font text_justify text-center mt-2"><b>Our Services</b></h3>
            ...
            <p class="text_justify pt-3"><b>Laptop/Desktop Rental:</b> In today's dynamic world, flexibility and
                convenience are
                paramount. That's why
                we
                offer a comprehensive laptop and desktop rental service. Whether you require a temporary workstation for
                a
                project, an extra computer for an event, or simply want to try out a specific model before purchasing,
                our
                rental service caters to your needs.</p>
        </div>

        <h3 class="text-center"><b>Why Choose Us:</b></h3>
